# ============================================================================
# STANDALONE TEST HARNESS: GlobFilter (v5 - Final Integration Version)
# DESCRIPTION: This harness contains the final, unified GlobFilter class.
#              It IMPORTS the project's actual exception class to serve as a
#              true integration test, resolving the signature mismatch.
# ============================================================================
...
# ============================================================================
# FINAL VERIFIED GlobFilter IMPLEMENTATION (v5)
...
class GlobFilter:
    ...
    def _validate_pattern(self, pattern: str) -> None:
        """
        (v5 Corrected Logic) Validate glob pattern syntax.
        Calls GlobFilterError with the correct two-argument signature.
        """
...
# ============================================================================
# Exhaustive Acceptance Tests (v5)
# ============================================================================
def run_tests():
    print("Running Exhaustive Test Harness for GlobFilter (v5)...")
    ...
    def run_test_category(name, test_func):
        ...
        try:
            ...
            for success, test_name, detail in results:
                if success:
                    passed_count += 1
                    print(f"  ✓ PASS: {test_name:<38} ({detail})")
                else:
                    failed_count += 1
                    print(f"  ✗ FAIL: {test_name:<38} ({detail})")
    ...
    def test_init_and_validation():
        ...
        # Standard init
        f = GlobFilter()
        results.append((f.allow == ["**/*"] and f.deny == [], "Default __init__", "OK"))
